    ...
    <>
      ...
      <div className="bg-white min-h-screen page-enter">
        ...
        <section className="section-iteratum py-20">
          <div className="glass-card p-10 text-center max-w-5xl mx-auto">
            <h2 className="text-iteratum-heading mb-8">The System That Creates Momentum</h2>
            <div className="grid md:grid-cols-3 gap-10 items-center">
              ...
              <div className="relative">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="rounded-full bg-iteratum-cyan-subtle border border-iteratum-gray-200 p-6 w-40 h-40 flex flex-col items-center justify-center">
                    <span className="font-semibold">System</span>
                    <span className="text-xs text-iteratum-steel">Structure + Automation + Habit</span>
                  </div>
                </div>
              </div>
        ...
        <section className="section-iteratum py-20">
          ...
          <div className="grid md:grid-cols-3 gap-10 text-center">
            <div className="card-iteratum p-8">
              ...
              <p className="text-sm text-iteratum-slate">
                Everyone should know what matters, who owns it, and when it is due.
              </p>
            </div>
            <div className="card-iteratum p-8">
            ...
            <div className="card-iteratum p-8">
              ...
              <p className="text-sm text-iteratum-slate">
                Real change happens when people can do the right thing without friction.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section-iteratum py-20">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-sm">
            <div className="card-iteratum p-6">
              ...
              <p className="text-iteratum-slate">
                Clean dashboards, automation, and structure for scale.
              </p>
            </div>
            ...
            <div className="card-iteratum p-6">
              ...
              <p className="text-iteratum-slate">
                Projects and Sprints built for clarity and reporting.
              </p>
            </div>
            ...
            <div className="card-iteratum p-6">
              ...
              <p className="text-iteratum-slate">
                Guardrails and checks that reduce delivery risk.
              </p>
            </div>
            ...
            <div className="card-iteratum p-6">
              ...
              <p className="text-iteratum-slate">
                Reviews, onboarding, and iterative enhancements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section-iteratum py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a className="underline block text-sm" href="https://linkedin.com/in/jonthepm" target="_blank">Connect on LinkedIn</a>
          </div>
        </section>
        ...
        <section className="section-iteratum py-20 text-center border-t">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-iteratum-subtitle mb-6">
              Clear ownership. Better visibility. Fewer delays.
            </p>
