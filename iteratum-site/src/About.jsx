...
const ASSETS = {
  ...
  zohoPartner: "/zoho-partner.png", // from earlier message (filename confirmed)
};
...
const Section = ({ id, className = "", children }) => (
  <section id={id} className={`section-iteratum page-enter ${className}`}>
    {children}
  </section>
);
...
/* ---------- Glass Card System Diagram (Row layout) ---------- */
function SystemDiagram() {
  // Row layout: Inputs → System Flow → Outputs
  return (
    <div className="card-iteratum-glass p-6 sm:p-8">
      <div className="grid lg:grid-cols-3 gap-6 items-stretch">
        {/* Inputs */}
        <div className="card-iteratum p-5">
          <div className="pill-iteratum mb-3">Inputs</div>
          <h4 className="text-iteratum-subheading">What We Align</h4>
          <ul className="mt-3 space-y-2 text-sm text-neutral-700">
            <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5" /> People and roles</li>
            <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5" /> Projects and workflows</li>
            <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5" /> Requests and intake</li>
          </ul>
        </div>

        {/* Flow */}
        <div className="card-iteratum p-5">
          <div className="pill-iteratum mb-3">Our System</div>
          <h4 className="text-iteratum-subheading">How The Work Flows</h4>
          <div className="mt-4">
            <svg viewBox="0 0 760 110" className="w-full h-auto" role="img" aria-label="Discovery to Improve flow">
              <defs>
              ...
              <path d="M20 60 H740" stroke="url(#line)" strokeWidth="3.5" fill="none" opacity="0.85" />
              {[
                { x: 20, t: "Discovery" },
                { x: 170, t: "Design" },
                { x: 320, t: "Build" },
                ...
                <g key={i}>
                  <circle cx={n.x} cy="60" r="6" fill={i < 5 ? "#06b6d4" : "#7c3aed"} />
                  <text x={n.x} y="86" fontSize="12" textAnchor="middle" fill="#0f172a" fontWeight="600">
                    {n.t}
                  </text>
                </g>
              ))}
          ...
          <p className="text-xs text-iteratum-steel mt-2">
            Structure, roles, views, automation, and reporting designed to match how your team actually works.
          </p>
        </div>

        {/* Outputs */}
        <div className="card-iteratum p-5">
          <div className="pill-iteratum mb-3">Outcomes</div>
          <h4 className="text-iteratum-subheading">What You Get</h4>
          <ul className="mt-3 space-y-2 text-sm text-neutral-700">
            <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5" /> One source of truth</li>
            <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5" /> On time delivery</li>
            <li className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5" /> Clear accountability</li>
          </ul>
        </div>
      </div>
    </div>
...
function Hero() {
  return (
    <Section id="hero" className="pt-28 pb-8 hero-iteratum">
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        <Card className="p-6">
          ...
          <div className="flex items-center gap-6 justify-center">
            <div className="rounded-xl bg-iteratum-gray-100 px-4 py-3">
...
function AdoptionAndDiagram() {
  return (
    <Section id="adoption" className="bg-iteratum-gradient-subtle">
      <div className="text-center max-w-3xl mx-auto">
